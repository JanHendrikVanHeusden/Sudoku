...
/** [GridEvent] to inform interested listeners of removal of value(s) from the [Cell.getValueCandidates] */
/**
 * [GridEvent] to inform interested listeners of removal of value(s) from the [Cell.getValueCandidates]
 * @property eventSource The [Cell] that is the source of this [CellRemoveCandidatesEvent]
 * @property removedCandidates The values being removed from the [Cell.getValueCandidates]
 * @constructor
 */
